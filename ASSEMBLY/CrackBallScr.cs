...
public class CrackBallScr : mScreen
{
	...
	private void doClickBall(int index)
	{
		...
		{
			SoundMn.gI().getItem();
			int num = ((typePrice != 0) ? Char.myCharz().checkLuong() : Char.myCharz().xu);
	...
	public override void paint(mGraphics g)
	{
		try
		{
			...
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().luongKhoa + string.Empty, num4 + 160, num5 - 13, mFont.LEFT, mFont.tahoma_7_grey);
